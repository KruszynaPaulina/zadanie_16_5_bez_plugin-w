    ...
    _createClass(App, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_Title2.default, { title: 'ToDo List', number: this.state.data.length }),
                _react2.default.createElement(_TodoList2.default, { tasks: this.state.data, remove: this.removeTodo })
            );
        }
    }]);
...
var TodoList = function TodoList(_ref2) {
    ...
    var todoList = tasks.map(function (task) {
        return _react2.default.createElement(Todo, { item: task, removeItem: remove, key: task.id });
    });
